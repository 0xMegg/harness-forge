...
|------|------|----------|------|-------|----------|
| 2026-04-29 | [round-4-p0-sync-fixes](./round-4-p0-sync-fixes.md) | P0 | fix | round 4 P0 — upgrade-harness scoped PROJECT_NAME substitution + missing phase wrapper manifest entries | no |
