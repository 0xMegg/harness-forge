...
|------|------|----------|------|-------|----------|
| 2026-05-01 | [pending](./pending-planner-role.md) | P2 | feat | Planner role boundary and verification planning hardening | no |
| 2026-04-29 | [12a6f9f](./12a6f9f.md) | P2 | feat | forge round 5 — Operating Mode template + meta-backlog 단일 위치 | no |
